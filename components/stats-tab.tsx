    ...
    <div className="flex flex-col items-center p-4 space-y-6">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Card>
            <CardContent className="p-4 flex flex-col items-center">
              <p className="text-4xl font-bold text-primary">{totalVolume.toLocaleString()}</p>
          ...
          <Card>
            <CardContent className="p-4 flex flex-col items-center">
              <p className="text-4xl font-bold text-primary">{averageDuration}</p>
          ...
          <Card>
            <CardContent className="p-4 flex flex-col items-center">
              <p className="text-4xl font-bold text-primary">{calculateWorkoutsPerWeek()}</p>
