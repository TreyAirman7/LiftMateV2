...
export default function WorkoutTracker({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Workout Header */}
      <div className="bg-teal-600 dark:bg-teal-800 text-white p-4 flex justify-between items-center">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {["chest", "back", "legs", "shoulders", "arms", "core"].map((muscle) => (
                          <div key={muscle} className="flex items-center space-x-2">
                            <input type="checkbox" id={`muscle-${muscle}`} className="rounded text-teal-600" />
                  ...
                  <Card>
                    <CardHeader className="pb-2">
                      <div className="flex justify-between items-center">
                        <CollapsibleTrigger className="flex items-center space-x-2 hover:text-teal-600">
