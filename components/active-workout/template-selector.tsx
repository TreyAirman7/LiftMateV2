...
export default function TemplateSelector({ onSelectTemplate }: TemplateSelectorProps) {
  ...
  return (
    <div className="min-h-screen bg-[#1c1b1f] text-white">
      {/* Header */}
      ...
      <div className="p-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-[#2a2930] text-white border-0 rounded-md py-3 pl-10 pr-4 focus:outline-none focus:ring-2"
            style={{
        ...
        <div className="px-4 mb-6">
          ...
          <div className="space-y-4">
            {recentTemplates.map((template) => (
              <div key={template.id} className="bg-[#2a2930] rounded-lg overflow-hidden border border-gray-800">
                <div
                ...
                <div className="p-4 space-y-3">
                  ...
                  <button
                    className="w-full py-3 rounded-md font-bold text-black flex items-center justify-center"
      ...
      <div className="px-4 pb-20">
        ...
        {filteredTemplates.length === 0 ? (
          <div className="bg-[#2a2930] rounded-lg p-6 text-center">
